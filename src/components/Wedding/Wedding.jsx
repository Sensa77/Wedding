    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.date}>
          <span className={styles.caption}>Когда</span>
        ...
        <div className={styles.location}>
          <span className={styles.caption}>Где</span>
          <p className={styles.description}>Церемония - ул.Стасова 174/1</p>
          <p className={styles.description}>Ресторан - ул.Селезнева 38</p>
        </div>
      </div>
      <button className={styles.button} type="button">Я приду</button>
    </div>
  )
}